...
export class ConsumerUserEvents {
    ...
    ): core.HttpResponsePromise<Flagright.ConsumerUserEventsCreateResponse> {
    ...
    private async __create(
        request: Flagright.ConsumerUserEventsCreateRequest,
        requestOptions?: ConsumerUserEvents.RequestOptions,
    ): Promise<core.WithRawResponse<Flagright.ConsumerUserEventsCreateResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ConsumerUserEventsCreateResponse.parseOrThrow(_response.body, {
