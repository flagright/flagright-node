...
export const PaymentMethodLimits: core.serialization.ObjectSchema<
    serializers.PaymentMethodLimits.Raw,
    Flagright.PaymentMethodLimits
...
export declare namespace PaymentMethodLimits {
    interface Raw {
