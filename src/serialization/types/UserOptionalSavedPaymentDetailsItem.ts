...
export const UserOptionalSavedPaymentDetailsItem: core.serialization.Schema<
    serializers.UserOptionalSavedPaymentDetailsItem.Raw,
    Flagright.UserOptionalSavedPaymentDetailsItem
> = core.serialization
    .union("method", {
        CARD: CardDetails,
    ...
    .transform<Flagright.UserOptionalSavedPaymentDetailsItem>({
...
export declare namespace UserOptionalSavedPaymentDetailsItem {
    export type Raw =
        | UserOptionalSavedPaymentDetailsItem.Card
        | UserOptionalSavedPaymentDetailsItem.GenericBankAccount
        | UserOptionalSavedPaymentDetailsItem.Iban
        | UserOptionalSavedPaymentDetailsItem.Ach
        | UserOptionalSavedPaymentDetailsItem.Swift
        | UserOptionalSavedPaymentDetailsItem.Mpesa
        | UserOptionalSavedPaymentDetailsItem.Upi
        | UserOptionalSavedPaymentDetailsItem.Wallet
        | UserOptionalSavedPaymentDetailsItem.Check
        | UserOptionalSavedPaymentDetailsItem.Cash
        | UserOptionalSavedPaymentDetailsItem.Npp;
