...
export declare namespace TransactionUpdatableOriginPaymentDetails {
    type Raw =
        | TransactionUpdatableOriginPaymentDetails.Card
        | TransactionUpdatableOriginPaymentDetails.GenericBankAccount
        | TransactionUpdatableOriginPaymentDetails.Iban
        | TransactionUpdatableOriginPaymentDetails.Ach
        | TransactionUpdatableOriginPaymentDetails.Swift
        | TransactionUpdatableOriginPaymentDetails.Mpesa
